    ...
    <div style="min-width: 100%">
        ...
        <q-card class="bg-blue-1 q-pa-md">
          ...
          <ul class="text-body2 q-mb-sm">
            <li v-for="idx in 2" :key="idx">
              <span v-html="t(`crcl.sections.definition.content.differences[${idx - 1}]`)"></span>
            </li>
          </ul>
        ...
        <q-card class="bg-green-1 q-pa-md">
          ...
          <ul class="text-body2 q-mb-md">
            <li v-for="idx in 3" :key="idx">
              <span v-html="t(`crcl.sections.physiology.content.mechanisms[${idx - 1}]`)"></span>
            </li>
          </ul>
          <p class="text-body2 q-mb-sm">
      ...
      >
        <q-card class="bg-amber-1 q-pa-md">
          ...
          <ul class="text-body2 q-mb-md">
            <li v-for="idx in 2" :key="idx">
              <span v-html="t(`crcl.sections.calculation.content.methods[${idx - 1}]`)"></span>
            </li>
          </ul>
          <p class="text-body2 text-weight-bold q-mb-sm">
      ...
      >
        <q-card class="bg-purple-1 q-pa-md">
          ...
          <ul class="text-body2 q-mb-md">
            <li v-for="idx in 3" :key="idx">
              <span v-html="t(`crcl.sections.applications.content.primaryUse[${idx - 1}]`)"></span>
            </li>
          </ul>
          ...
          <ul class="text-body2">
            <li v-for="idx in 3" :key="idx">
              <span
                v-html="t(`crcl.sections.applications.content.specialPopulations[${idx - 1}]`)"
              ></span>
            </li>
          </ul>
        </q-card>
      ...
      >
        <q-card class="bg-red-1 q-pa-md">
          ...
          <q-banner class="bg-red-2 text-red-9 q-mt-md" rounded>
            ...
            <div class="text-caption">
              <strong>{{ t('crcl.sections.referenceValues.content.clinicalAlert.title') }}</strong>
              <span v-html="t('crcl.sections.referenceValues.content.clinicalAlert.text')"></span>
            </div>
          </q-banner>
        </q-card>
      </q-expansion-item>
      ...
      >
        <q-card class="bg-teal-1 q-pa-md">
          ...
          <ul class="text-body2">
            <li v-for="idx in 3" :key="idx">
              <span v-html="t(`crcl.sections.bibliography.content.guidelines[${idx - 1}]`)"></span>
            </li>
          </ul>
          ...
          <q-banner class="bg-teal-2 text-teal-9 q-mt-md" rounded>
            ...
            <div class="text-caption">
              <strong>{{ t('crcl.sections.bibliography.content.onlineResources.title') }}</strong>
              <a
