...
<template>
  <div class="q-pa-md">
    ...
    <div class="row justify-center q-gutter-md">
      ...
      <div class="row q-mt-md col-12 col-md-6">
        <div class="col-12">
          <q-card flat bordered>
            <q-card-section>
              <div class="text-subtitle2 text-weight-bold q-mb-md">
              ...
              <div class="q-mb-md row justify-center">
                <q-chip
                  ...
                  style="min-width: 300px"
                >
                  <strong>Range MP: </strong> 12 - 15 J/min</q-chip
                >
              </div>
        ...
        <q-list>
          <q-item>
            ...
            <q-item-section>
              ...
              <q-item-label caption class="q-mt-xs">
                <div v-html="t('mp.definition.clinicalSignificance.viliPredictor.text')"></div>
              </q-item-label>
            </q-item-section>
          </q-item>
          ...
          <q-item>
            ...
            <q-item-section>
              ...
              <q-item-label caption class="q-mt-xs">
                <div v-html="t('mp.definition.clinicalSignificance.prognosticValue.text')"></div>
              </q-item-label>
            </q-item-section>
          </q-item>
          ...
          <q-item>
            ...
            <q-item-section>
              ...
              <q-item-label caption class="q-mt-xs">
                <div v-html="t('mp.definition.clinicalSignificance.optimization.text')"></div>
              </q-item-label>
            </q-item-section>
          </q-item>
      ...
      <q-card class="q-pa-md">
          ...
          <q-item>
            ...
            <q-item-section>
              ...
              <q-item-label caption>
                ...
                <div v-html="t('mp.measurement.pplateau.measurement')" class="q-mt-xs"></div>
                <div v-html="t('mp.measurement.pplateau.normalRange')" class="q-mt-xs"></div>
                <div v-html="t('mp.measurement.pplateau.clinicalNote')" class="q-mt-xs"></div>
              </q-item-label>
            </q-item-section>
          </q-item>
        ...
        <q-banner class="bg-amber-1 text-amber-9 q-mt-md">
          ...
          <div class="text-caption">
            ...
            <div v-html="t('mp.measurement.practicalConsiderations.breathVariability')"></div>
            (2)
        ...
        <q-item>
          ...
          <q-item-section>
            ...
            <q-item-label caption>
              ...
              <div v-html="t('mp.interpretation.greenZone.mortality')" class="q-mt-xs"></div>
              <div v-html="t('mp.interpretation.greenZone.meaning')" class="q-mt-xs"></div>
              <div v-html="t('mp.interpretation.greenZone.clinicalAction')" class="q-mt-xs"></div>
            </q-item-label>
          </q-item-section>
        </q-item>
        ...
        <q-item>
          ...
          <q-item-section>
            ...
            <q-item-label caption>
              ...
              <div v-html="t('mp.interpretation.orangeZone.mortality')" class="q-mt-xs"></div>
              <div v-html="t('mp.interpretation.orangeZone.meaning')" class="q-mt-xs"></div>
              <div v-html="t('mp.interpretation.orangeZone.clinicalAction')" class="q-mt-xs"></div>
            </q-item-label>
          </q-item-section>
        </q-item>
        ...
        <q-item>
          ...
          <q-item-section>
            ...
            <q-item-label caption>
              ...
              <div v-html="t('mp.interpretation.redZone.clinicalAction')" class="q-mt-xs"></div>
            </q-item-label>
          </q-item-section>
        </q-item>
      </q-list>
      ...
      <q-card class="q-pa-sm">
        ...
        <div class="bg-white q-pa-sm q-mb-xs">
          ...
          <q-list class="q-pl-md">
            ...
            <q-item>
              <q-item-section>
                <q-item-label caption>{{ t('mp.formula.exampleParams.peep') }}</q-item-label>
              </q-item-section>
            </q-item>
          </q-list>
