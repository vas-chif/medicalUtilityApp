...
export default {
  ...
  interpretation: {
    ...
    clinicalNotes: {
      normal:
        'Clearance normale. Dosaggio farmaci standard (verificare schede tecniche).',
      mildReduction:
  ...
  sections: {
    ...
    definition: {
      ...
      content: {
        mainDefinition: {
          title: 'Definizione:',
          text: 'La Creatinine Clearance (CrCl) rappresenta il volume di plasma completamente depurato dalla creatinina per unita di tempo, espresso in mL/min. E una stima della filtrazione glomerulare utilizzata principalmente per il dosaggio dei farmaci.',
        },
        difference: {
          title: 'Differenza tra CrCl e eGFR:',
          items: [
    ...
    physiology: {
      ...
      content: {
        mechanism: {
          title: 'Meccanismo Clearance:',
          intro: 'La clearance renale di una sostanza e determinata da tre processi:',
          processes: [
    ...
    // SEZIONE 7: Valori di Riferimento e Alert
    referenceValues: {
